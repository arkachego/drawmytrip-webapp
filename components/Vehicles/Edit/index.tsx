...
import { Button, Drawer, Fieldset, FileInput, Flex, NumberInput, Select, Stack, Text, TextInput, Textarea } from "@mantine/core";
    ...
    >
      {vehicle && (
        <>
          ...
          />
          <Stack gap="md">
            <Fieldset legend="Required Fields">
              <Stack gap="md">
                <TextInput
                  required={true}
                  label="Title"
            ...
            <Fieldset legend="Optional Fields">
              <Stack gap="md">
                <FileInput
                  label="Image"
